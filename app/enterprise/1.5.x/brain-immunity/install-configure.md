...
* **Collector App** enables communication between Kong Enterprise and Brain and/or Immunity. The Kong Collector App comes with your purchase of Brain and/or Immunity.
...
* Access to the Kong Bintray repository (https://bintray.com/kong), including your access credentials supplied by Kong (BINTRAY_USERNAME, BINTRAY_API_KEY).
...
To enable Kong Brain and/or Immunity, you must first configure the Collector App and the Collector Plugin. This includes:
...
### Setting up the Collector App via Docker Compose
### Docker login
...
### Setting up the Collector App via Helm
There is a public Helm chart for setting up the Collector App and all its dependencies on Kubernetes.  Instructions for setup can be found on the public repo at: [https://github.com/Kong/kong-collector-helm/blob/master/README.md](https://github.com/Kong/kong-collector-helm/blob/master/README.md)
